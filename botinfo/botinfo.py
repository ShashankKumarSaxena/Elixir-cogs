...
class Info(commands.Cog):
    ...
    async def about(self,ctx):
        ...
        em.add_field(name="Story Behind Elixir",value="Elixir was made by Ronish and then developed by others elixir has its own [website](https://bit.ly/elixirbot) now and also on [Top.gg](https://top.gg/bot/732916004656513077) also now elixir has a [Status Page](https://elixir.betteruptime.com/)  for any support join the [support server](https://discord.gg/padK6GW)")
        em.set_thumbnail(url="https://cdn.discordapp.com/avatars/732916004656513077/8636fca205b8c8eb71cd5f1c5ec91cd9.png?size=1024",inline=False)
