...
class Info(commands.Cog):
    ...
    async def about(self,ctx):
        ...
        em.add_field(name="About Elixir",value=f"This bot is an instance of [Red, an open source Discord bot](https://github.com/Cog-Creators/Red-DiscordBot) created by [Twentysix](https://github.com/Twentysix26) and [improved by many.](https://github.com/Cog-Creators)\nElixir was made by Ronish and then developed by others elixir has its own [website](https://bit.ly/elixirbot) now and also on [Top.gg](https://top.gg/bot/732916004656513077) also now elixir has a [Status Page](https://elixir.betteruptime.com/)  for any support join the [support server](https://discord.gg/padK6GW)")
